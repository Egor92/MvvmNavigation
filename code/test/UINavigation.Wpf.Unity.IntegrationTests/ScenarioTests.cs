...
using Egor92.UINavigation.Wpf.Unity.IntegrationTests.Internal;
using Egor92.UINavigation.Wpf.Unity.IntegrationTests.Internal.Types;
using NUnit.Framework;
using Unity;

namespace Egor92.UINavigation.Wpf.Unity.IntegrationTests
{
    [TestFixture]
