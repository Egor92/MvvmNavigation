...
using Egor92.MvvmNavigation.Wpf.Unity.IntegrationTests.Internal;
using Egor92.MvvmNavigation.Wpf.Unity.IntegrationTests.Internal.Types;
using NUnit.Framework;
using Unity;

namespace Egor92.MvvmNavigation.Wpf.Unity.IntegrationTests
{
    [TestFixture]
